...
public class PasswordDAOImpl implements PasswordDAO {
	...
	try{
        ...
        if ((list1 != null) && UserBean!=null){
            ...
            String emailMessage="Dear "+UserBean.getUsername()+",<br><br>The OTP to reset your password in Paladion Teamwork Portal is:<b> " +otp+ "</b>.<br><br>OTP is valid for only 10 Minutes.<br><br>Please ignore if this request was not generated by you.<br><br><b>This is a system generated mail. Please donot reply to this mail.<br><br>Yours robotically,<br>TeamWork Admin "+" (http://10.0.1.11:8090/TeamWorkAlpha)<br>Paladion Networks<br>"; 
