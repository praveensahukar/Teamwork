...
public class PasswordDAOImpl implements PasswordDAO {
	...
	try{
        ...
        if ((list1 != null) && UserBean!=null){
            ...
            String emailMessage="Dear "+UserBean.getUsername()+",<br><br>The OTP to reset your password in Paladion Teamwork Portal is:<b> " +otp+ "</b>.<br><br>OTP is valid for only 10 Minutes.<br><br>Please ignore if this request was not generated by you.<br><br>Regards,<br>Team Paladion";
