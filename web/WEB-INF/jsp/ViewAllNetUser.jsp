<%-- 
    Document   : ViewAllNetUser
    Created on : May 28, 2020, 5:04:41 PM
    Author     : pal
--%>

<%-- 
    Document   : ViewAllAppSecUser
    Created on : May 28, 2020, 4:50:57 PM
    Author     : pal
--%>
...
<title>All Application Security Users</title>
</head>
    
<body>
    <%@include file="Header.jsp" %>        
    <div class="login-card">
    <div align="left">  <h2 style="color: #a6a6a6; font-family: sans-serif; font-style: normal">Application Security Engineers</h2><br></div>
    ...
    <tbody>
        <c:forEach  items="${AllNetUsers}" var="user">     
            <tr> 
                <td> 
