<%-- 
    Document   : UpdateIptDetails
    Created on : Apr 23, 2020, 2:07:02 PM
    Author     : pal
--%>
...
<!--action="getEngineers.do"-->
    <form:form  method="post" action="UpdateIptActivity.do" modelAttribute="IPTBean">
         <input type="hidden" name="AntiCSRFToken" id="token" value="${csrfPreventionSalt}"/>
          <input type="hidden" name="iptid" value="${iptid}"/>
                ...
                <table align="right" border="0" cellpadding="10" cellspacing="2">
                    <tr>
                        <td>
                            ...
                            <form:input placeholder="Enter Start Date" id="txtFromDate1" path="prefstartdate" value="${fn:escapeXml(IPTData.prefstartdate)}"/>
                        </td>
                        <td>
                            <label>Hosting Environment:</label>
                            <form:input type="text" name="eft" id="task1" placeholder="Hosting Environment" path="hosting" value="${fn:escapeXml(IPTData.hosting)}" />
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <form:input type="text" name="eft" id="task11" placeholder="VPN Connectivity" path="vpnConn" value="${fn:escapeXml(IPTData.vpnConn)}" />
                        </td>
                        <td>
                             <label>Time window:</label>
                             <form:input type="text" name="eft" id="task12" placeholder="Time window" path="timewindow" value="${fn:escapeXml(IPTData.timewindow)}" />
                        </td>
                    </tr>
