<%-- 
    Document   : DisplayVascan
    Created on : Apr 16, 2020, 3:09:28 PM
    Author     : pal
--%>
...
<title>All VA-Scan</title>
</head>
    
<body>
    <%@include file="Header.jsp" %>        
    <div class="login-card">
    <div align="left">  <h2 style="color: #a6a6a6; font-family: sans-serif; font-style: normal">All VA-Scan scheduling:</h2><br></div>
    ...
    <tbody>
        ...
        <c:forEach  items="${AllVascan}" var="Vascan">     
           <tr>
               <td> 
               ...
               <td> ${fn:escapeXml(Vascan.timewindow)}</td>
