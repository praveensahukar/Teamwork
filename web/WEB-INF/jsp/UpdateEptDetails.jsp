<%-- 
    Document   : UpdateEptDetails
    Created on : Apr 23, 2020, 1:38:10 PM
    Author     : pal
--%>
                ...
                <table align="right" border="0" cellpadding="10" cellspacing="2">
                    <tr>
                        <td>
                            ...
                            <form:input placeholder="Enter Start Date" id="txtFromDate1" path="prefstartdate" value="${fn:escapeXml(EPTData.prefstartdate)}"/>
                        </td>
                        <td>
                            <label>Hosting Environment:</label>
                            <form:input type="text" name="eft" id="task1" placeholder="Hosting Environment" path="hosting" value="${fn:escapeXml(EPTData.hosting)}" />
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <form:input type="text" name="eft" id="task9" placeholder="Whitelisting Confirmation" path="whitelistconf" value="${fn:escapeXml(EPTData.whitelistconf)}" />
                        </td>
                        <td>
                             <label>Time window:</label>
                            <form:input type="text" name="eft" id="task10" placeholder="Time window" path="timewindow" value="${fn:escapeXml(EPTData.timewindow)}" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>Domain:</label>
                            <form:input type="text" name="eft" id="task7" placeholder="Domain" path="domain"  value="${fn:escapeXml(EPTData.domain)}" />
                        </td>
                        <td>
                             <label>IP's in proposal:</label>
                            <form:input type="text" name="eft" id="task8" placeholder="IP's in proposal" path="ipproposal" value="${fn:escapeXml(EPTData.ipproposal)}" />
                        </td>
                    </tr>
                    <tr>
