<%-- 
    Document   : DisplayIpt
    Created on : Apr 16, 2020, 2:57:07 PM
    Author     : pal
--%>
...
<title>All IPTActivity</title>
</head>
    
<body>
    <%@include file="Header.jsp" %>        
    <div class="login-card">
    <div align="left">  <h2 style="color: #a6a6a6; font-family: sans-serif; font-style: normal">All IPTScheduling</h2><br></div>
    ...
    <tbody>
        ...
        <c:forEach  items="${AllIpt}" var="IptActivity">     
           <tr>
               <td> 
               ...
               <td> ${fn:escapeXml(IptActivity.timewindow)}</td>
